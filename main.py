...
from DataFrame_convetor import fetch_medal_tally,country_year_list,data_over_time,most_successful,yearwise_medal_tally
from DataFrame_convetor import country_event_heatmap,most_successful_countrywise,weight_v_height,men_vs_women,preprocess
import json
import time
import requests
...
lottie_ol = load_lottiefile("base.json")
